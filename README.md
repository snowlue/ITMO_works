...
- [1-й курс](#1-й-курс)
  ...
  - [2-й семестр](#2-й-семестр)
    ...
    - [Факультатив «Анализ текстовых данных на Python»ㅤ`python` `питон` `пайтон` `сентимент`](#факультатив-анализ-текстовых-данных-на-pythonㅤpython-питон-пайтон-сентимент)
...
### Факультатив «Анализ текстовых данных на Python»ㅤ`python` `питон` `пайтон` `сентимент`
Список лекций:
