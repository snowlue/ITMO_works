...
- мегафакультет КТУ[^ctam]ㅤ`КТиУ`
- факультет СУиР[^csar]
- направление «24.03.02 Системы управления движением и навигация»ㅤ`СУДиН`
- образовательная программа «Робототехника и искусственный интеллект»ㅤ`РиИИ`
...
## 3-й семестр (II курс)
### Безопасность жизнедеятельностиㅤ`бжд`
<table>
    <tbody>
        <tr>
            <td><b>Тема</b></td>
...
### Бизнес-модели основных секторов инновационной экономикиㅤ`бмс`
...
### Практическая линейная алгебраㅤ`пла` `линал` `линейка` `линалгебра`
> Перегудин А.А.
...
### Теоретическая механикаㅤ`теормех` `тм` `физика` `physics` `mechanics`
> Скорых В.А.
<table>
    <tbody>
        <tr>
...
### Электричество и магнетизмㅤ`элмаг` `эим` `эм` `электромагнетизм` `физика` `physics`
> Боярский К.К.
...
### Инновационная экономика и технологическое предпринимательствоㅤ`иэк` `иэтп` `стартап`
> Макаренко Е.Д.
<table>
    <tbody>
...
### Теория вероятностейㅤ`теорвер` `тв`
...
### Техники публичных выступлений и презентацийㅤ`тпв` `софты` `soft skills`
> Лимонова В.М.
...
### Техническое зрениеㅤ`техзрение` `тз` `techvision`
> Шаветов С.В.
