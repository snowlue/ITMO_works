...
# Содержание
Кроме подробного содержания по всему документу расставлены теги, по которым бывает проще найти нужную дисциплину да и вообще эту репу в поиске.
- [1-й курс](#1-й-курс)
  - [1-й семестр](#1-й-семестр)
    - [Программирование на Pythonㅤ`прога` `питон` `пайтон`](#программирование-на-pythonㅤпрога-питон-пайтон)
    ...
    - [Компьютерная и инженерная графикаㅤ`киг` `инжграф` `инжграфика`](#компьютерная-и-инженерная-графикаㅤкиг-инжграф-инжграфика)
    - [Введение в профессиональную деятельностьㅤ`впд`](#введение-в-профессиональную-деятельностьㅤвпд)
  - [2-й семестр](#2-й-семестр)
    - [Программирование на Pythonㅤ`прога` `питон` `пайтон`](#программирование-на-pythonㅤпрога-питон-пайтон-1)
    - [Линейная алгебраㅤ`линал` `линейка` `линалгебра`](#линейная-алгебраㅤлинал-линейка-линалгебра-1)
    - [Математический анализㅤ`матан` `матанализ` `ma` `mi`](#математический-анализㅤматан-матанализ-ma-mi)
    - [Механикаㅤ`мех` `физика` `physics` `mechanics`](#механикаㅤмех-физика-physics-mechanics)
    - [Коммуникации и командообразованиеㅤ`кик` `cat` `тимбилдинг` `общение` `софты` `soft skills`](#коммуникации-и-командообразованиеㅤкик-cat-тимбилдинг-общение-софты-soft-skills)
    - [Россия в истории современных международных отношенийㅤ`история` `ирс`](#россия-в-истории-современных-международных-отношенийㅤистория-ирс)
    - [Введение в профессиональную деятельность. Проектная деятельностьㅤ`впд`](#введение-в-профессиональную-деятельность-проектная-деятельностьㅤвпд)
    - [Построение научной работыㅤ`пнр`](#построение-научной-работыㅤпнр)
    - [Факультатив «Анализ текстовых данных на Python»ㅤ`питон` `пайтон` `сентимент`](#факультатив-анализ-текстовых-данных-на-pythonㅤпитон-пайтон-сентимент)
- [2-й курс](#2-й-курс)
  - [3-й семестр](#3-й-семестр)
    - [Безопасность жизнедеятельностиㅤ`бжд`](#безопасность-жизнедеятельностиㅤбжд)
    - [Бизнес-модели основных секторов инновационной экономикиㅤ`бмс`](#бизнес-модели-основных-секторов-инновационной-экономикиㅤбмс)
    - [Дифференциальные уравненияㅤ`дифуры` `диффуры` `ду` `de`](#дифференциальные-уравненияㅤдифуры-диффуры-ду-de)
    - [Математический анализㅤ`матан` `матанализ` `ma` `mi`](#математический-анализㅤматан-матанализ-ma-mi-1)
    - [Операционная система ROSㅤ`рос`](#операционная-система-rosㅤрос)
    - [Практическая линейная алгебраㅤ`пла` `линал` `линейка` `линалгебра`](#практическая-линейная-алгебраㅤпла-линал-линейка-линалгебра)
    - [Теоретическая механикаㅤ`теормех` `тм` `физика` `physics` `mechanics`](#теоретическая-механикаㅤтеормех-тм-физика-physics-mechanics)
    - [Электричество и магнетизмㅤ`элмаг` `эим` `эм` `электромагнетизм` `физика` `physics`](#электричество-и-магнетизмㅤэлмаг-эим-эм-электромагнетизм-физика-physics)
    - [Языки программированияㅤ`япы` `programming languages` `pls`](#языки-программированияㅤяпы-programming-languages-pls)
  - [4-й семестр](#4-й-семестр)
    - [Алгоритмы и структуры данныхㅤ`аисд` `алгосы`](#алгоритмы-и-структуры-данныхㅤаисд-алгосы)
    - [Дифференциальные уравненияㅤ`дифуры` `диффуры` `ду` `de`](#дифференциальные-уравненияㅤдифуры-диффуры-ду-de-1)
    - [Инновационная экономика и технологическое предпринимательствоㅤ`иэк` `иэтп`](#инновационная-экономика-и-технологическое-предпринимательствоㅤиэк-иэтп)
    - [Практикаㅤ`practice`](#практикаㅤpractice)
    - [Теория вероятностейㅤ`теорвер` `тв`](#теория-вероятностейㅤтеорвер-тв)
    - [Техники публичных выступлений и презентацийㅤ`тпв` `софты` `soft skills`](#техники-публичных-выступлений-и-презентацийㅤтпв-софты-soft-skills)
    ...
    - [Электротехникаㅤ`эт` `элтехника`](#электротехникаㅤэт-элтехника)
...
### Языки программированияㅤ`япы` `programming languages` `pls`

## 4-й семестр
### Алгоритмы и структуры данныхㅤ`аисд` `алгосы`
### Дифференциальные уравненияㅤ`дифуры` `диффуры` `ду` `de`
### Инновационная экономика и технологическое предпринимательствоㅤ`иэк` `иэтп`
### Практикаㅤ`practice`
